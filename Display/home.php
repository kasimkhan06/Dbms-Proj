        ...
        <div class="hero">
            ...
            <form class="search-form" action="" method="get">
                <div class="search-container">
                    ...
                    <input class="search" name="search" placeholder="Search"></input>
                </div>
        ...
        <div class="property-grid">
            ...
            ?>
                        <div class="property-card">
                            ...
                            <a class="view-details-button"href="property-details.php?id=<?php echo $items['property_id']; ?>">View Details</a>
                        </div>
            <?php
                    }
                } else {
            ...
            ?>
                    <div class="property-card">
                        ...
                        <a class="view-details-button"href="property-details.php?id=<?php echo $property_result['property_id']; ?>">View Details</a>
                    </div>
            <?php
                }
            }
